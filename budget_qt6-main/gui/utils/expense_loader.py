...
class ExpenseLoader:
    ...
    def __init__(self):
        ...
        self.category_mappings = {
            ...
            'WALGREENS': ('Healthcare', 'Misc Healthcare'),
            'CVS': ('Healthcare', 'Misc Healthcare'),
            'RITE AID': ('Healthcare', 'Misc Healthcare'),
            'PHARMACY': ('Healthcare', 'Misc Healthcare'),
            'DOCTOR': ('Healthcare', 'Jeff Doctor'),
            'MEDICAL': ('Healthcare', 'Other Doctor Visits'),
            'DENTAL': ('Healthcare', 'Other Doctor Visits'),

            # Technology and entertainment
            'APPLE.COM': ('Other', 'Entertainment'),
            'AMAZON': ('Other', 'Other'),
            'NETFLIX': ('Other', 'Entertainment'),
            'SPOTIFY': ('Other', 'Entertainment'),
            ...
            'SAFEWAY': ('Food', 'Food (Groceries)'),
            'KROGER': ('Food', 'Food (Groceries)'),
            'GROCERY': ('Food', 'Food (Groceries)'),
            'SUPERMARKET': ('Food', 'Food (Groceries)'),

            # Restaurants and dining
            'RESTAURANT': ('Food', 'Food (Dining Out)'),
            'MCDONALD': ('Food', 'Food (Take Out)'),
            'BURGER': ('Food', 'Food (Take Out)'),
            'PIZZA': ('Food', 'Food (Take Out)'),
            ...
            'BP': ('Vehicles', 'Gas'),
            'MOBIL': ('Vehicles', 'Gas'),
            'CHEVRON': ('Vehicles', 'Gas'),
            'GAS STATION': ('Vehicles', 'Gas'),
            'AUTO REPAIR': ('Vehicles', 'Vehicle Fixes'),
            'JIFFY LUBE': ('Vehicles', 'Oil Changes'),
            ...
            'HARDWARE': ('Home', 'Tools / Hardware'),
            'FURNITURE': ('Home', 'Home Décor'),
            'IKEA': ('Home', 'Home Décor'),

            # Travel and transportation
            'AIRLINE': ('Vacation', 'Flights/Travel'),
            'HOTEL': ('Vacation', 'Housing'),
            'RENTAL CAR': ('Vacation', 'Rental Car'),
            'UBER': ('Utilities', 'Taxi / Transit'),
            'LYFT': ('Utilities', 'Taxi / Transit'),
            'TAXI': ('Utilities', 'Taxi / Transit'),
